...
import canadianClubBanner from "../../assets/brandimages/CanadianClub.jpg";

const BRAND_NAME = "Canadian Club";

export default function CanadianClub({
  products = [],

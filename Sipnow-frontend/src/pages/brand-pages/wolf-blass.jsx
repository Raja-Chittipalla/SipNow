...
import wolfBlassBanner from "../../assets/brandimages/WolfBlass.jpg";

const BRAND_NAME = "Wolf Blass";

export default function WolfBlass({
  products = [],
        ...
        <div className="max-w-container-max mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-6 text-base md:text-lg leading-relaxed text-on-surface-variant">
              Explore our collection of Wolf Blass wines, from vibrant whites

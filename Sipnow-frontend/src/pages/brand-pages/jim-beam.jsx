...
// const BRAND_NAME = "Jim Beam";

// TODO: build out real brand content/products here, same pattern as
// JacobsCreek.jsx. Already routed at /brands/jim-beam in App.jsx —
// no App.jsx changes needed to finish this page.
// export default function JimBeam({ onBack }) {
//   return (
...
import jimBeamBanner from "../../assets/brandimages/JimBeam.jpg";

const BRAND_NAME = "Jim Beam";

export default function JimBeam({
  products = [],
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="mt-3 text-sm md:text-base text-on-surface-variant">
                Discover the most popular Jim Beam products.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-container-max mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="mt-3 text-sm md:text-base text-on-surface-variant">
                Explore the highest-rated Jim Beam products.
              </p>
            </div>
          </div>

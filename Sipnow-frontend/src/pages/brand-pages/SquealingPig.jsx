...
import squealingPigBanner from "../../assets/brandimages/SquealingPig.jpg";

const BRAND_NAME = "Squealing Pig";

export default function SquealingPig({
  products = [],
  ...
  const brandProducts = useMemo(() => {
    return products.filter((product) => {
      ...
      return (
        brand === "squealing pig" ||
        brand.includes("squealing pig") ||
        name.includes("squealing pig")
      );
    });
  }, [products]);
        ...
        <div className="max-w-container-max mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="font-serif text-3xl md:text-5xl text-on-surface">
              Squealing Pig Collection
            </h2>

            <p className="mt-6 text-base md:text-lg leading-relaxed text-on-surface-variant">
              Explore the Squealing Pig collection featuring approachable,
              flavour-packed wines and refreshing sparkling and spritz
              selections. Discover favourites including Sauvignon Blanc, Pinot
              Gris, Rosé, Pinot Noir and more.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-container-max mx-auto">
          <div className="mb-8">
            ...
            <p className="mt-3 text-sm md:text-base text-on-surface-variant">
              Discover the most popular Squealing Pig products.
            </p>
          </div>
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best selling Squealing Pig products will appear here once
      ...
      <section className="px-margin-mobile md:px-margin-desktop pb-20">
        <div className="max-w-container-max mx-auto">
          <div className="mb-8">
            ...
            <p className="mt-3 text-sm md:text-base text-on-surface-variant">
              Explore the highest-rated Squealing Pig products.
            </p>
          </div>
          ...
          {productsLoading ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best rated Squealing Pig products will appear here once
          ...
          {brandProducts.length > 0 ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <h3 className="font-serif text-2xl text-on-surface mb-3">
                  Squealing Pig Products
                </h3>

                <p className="text-on-surface-variant leading-relaxed">
                  Squealing Pig products will appear here once they are

...
import belenaBanner from "../../assets/brandimages/Belena.jpg";
const BRAND_NAME = "Belena";

export default function Belena({
  products = [],
  ...
  const brandProducts = useMemo(() => {
    return products.filter((product) => {
      ...
      return brand === "belena" || name.includes("belena");
    });
  }, [products]);
        ...
        <div className="max-w-container-max mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-6 text-base md:text-lg leading-relaxed text-on-surface-variant">
              Explore the Belena collection and discover wines crafted to bring
              quality, character and flavour to every occasion. Browse the
        ...
        <div className="max-w-container-max mx-auto">
          <div className="mb-8">
            ...
            <p className="mt-3 text-sm md:text-base text-on-surface-variant">
              Explore our best-selling Belena wines.
            </p>
          </div>
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best-selling Belena products will appear here once sales data
                  is available.
                </p>
              </div>
            </div>
      ...
      <section className="px-margin-mobile md:px-margin-desktop pb-20">
        <div className="max-w-container-max mx-auto">
          <div className="mb-8">
            ...
            <p className="mt-3 text-sm md:text-base text-on-surface-variant">
              Explore our highest-rated Belena wines.
            </p>
          </div>
          ...
          {productsLoading ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best-rated Belena products will appear here once product
          ...
          {brandProducts.length > 0 ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Belena products will appear here once they are available in
                  our collection.
                </p>
              </div>
            </div>

...
import lindemansBanner from "../../assets/brandimages/lindemans.jpg";

const BRAND_NAME = "Lindeman's";

export default function Lindemans({
  products = [],
   ...
   * ============================================================
   *
   * Products will come from the backend/database.
   * Until then, products can be an empty array.
   */
  ...
  const brandProducts = useMemo(() => {
    return products.filter((product) => {
      ...
      return (
        brand === "lindeman's" ||
        brand === "lindemans" ||
        name.includes("lindeman's") ||
        name.includes("lindemans")
      );
    });
  }, [products]);
        ...
        <div className="max-w-container-max mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="font-serif text-3xl md:text-5xl text-on-surface">
              Lindeman's Collection
            </h2>

            <p className="mt-6 text-base md:text-lg leading-relaxed text-on-surface-variant">
              Explore our collection of Lindeman's wines. Discover a selection
              of quality wines crafted with Australian character, offering
              refreshing whites, rich reds and elegant varieties for every
              occasion.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="mt-3 text-sm md:text-base text-on-surface-variant">
                Discover the most popular Lindeman's products.
              </p>
            </div>
          </div>
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best selling Lindeman's products will appear here once product
        ...
        <div className="max-w-container-max mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="mt-3 text-sm md:text-base text-on-surface-variant">
                Explore the highest-rated Lindeman's products.
              </p>
            </div>
          </div>
          ...
          {productsLoading ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best rated Lindeman's products will appear here once product
          ...
          {brandProducts.length > 0 ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Lindeman's products will appear here once they are available
                  in our collection.
                </p>
              </div>
            </div>

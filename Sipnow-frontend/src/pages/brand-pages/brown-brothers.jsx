...
import brownBrothersBanner from "../../assets/brandimages/brown-brothers-banner.jpg";

const BRAND_NAME = "Brown Brothers";

export default function BrownBrothers({
  products = [],
  ...
  const brandProducts = useMemo(() => {
    return products.filter((product) => {
      ...
      return (
        ...
        brand === "brownbrothers" ||
        name.includes("brown brothers") ||
        name.includes("brownbrothers")
      );
    });
  }, [products]);
        ...
        <div className="max-w-container-max mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-6 text-base md:text-lg leading-relaxed text-on-surface-variant">
              Explore the Brown Brothers collection and discover wines crafted
              with quality, character and flavour. Browse the collection and
              find a bottle to suit every occasion.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-container-max mx-auto">
          <div className="mb-8">
            ...
            <p className="mt-3 text-sm md:text-base text-on-surface-variant">
              Explore our best-selling Brown Brothers wines.
            </p>
          </div>
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best-selling Brown Brothers products will appear here once
      ...
      <section className="px-margin-mobile md:px-margin-desktop pb-20">
        <div className="max-w-container-max mx-auto">
          <div className="mb-8">
            ...
            <p className="mt-3 text-sm md:text-base text-on-surface-variant">
              Explore our highest-rated Brown Brothers wines.
            </p>
          </div>
          ...
          {productsLoading ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best-rated Brown Brothers products will appear here once
          ...
          {brandProducts.length > 0 ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Brown Brothers products will appear here once they are

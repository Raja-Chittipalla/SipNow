...
import mcguiganBanner from "../../assets/brandimages/McGuigan.jpg";

const BRAND_NAME = "McGuigan";

export default function McGuigan({
  products = [],
  ...
  const brandProducts = useMemo(() => {
    return products.filter((product) => {
      ...
      return (
        brand === "mcguigan" ||
        brand.includes("mcguigan") ||
        name.includes("mcguigan")
      );
    });
  }, [products]);
        ...
        <div className="max-w-container-max mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-6 text-base md:text-lg leading-relaxed text-on-surface-variant">
              Explore our collection of McGuigan wines, featuring a range of
              Australian wines crafted with quality, character and winemaking
              expertise for every occasion.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="mt-3 text-sm md:text-base text-on-surface-variant">
                Discover the most popular McGuigan products.
              </p>
            </div>
          </div>
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best selling McGuigan products will appear here once product
        ...
        <div className="max-w-container-max mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="mt-3 text-sm md:text-base text-on-surface-variant">
                Explore the highest-rated McGuigan products.
              </p>
            </div>
          </div>
          ...
          {productsLoading ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best rated McGuigan products will appear here once product
          ...
          {brandProducts.length > 0 ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  McGuigan products will appear here once they are available in
                  our collection.
                </p>
              </div>
            </div>

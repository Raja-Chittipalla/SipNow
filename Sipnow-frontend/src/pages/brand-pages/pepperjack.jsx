...
import pepperjackBanner from "../../assets/brandimages/PepperJack.jpg";

const BRAND_NAME = "Pepperjack";
  ...
  const brandProducts = useMemo(() => {
    return products.filter((product) => {
      ...
      return (
        brand === "pepperjack" ||
        brand === "pepper jack" ||
        brand.includes("pepperjack") ||
        brand.includes("pepper jack") ||
        name.includes("pepperjack") ||
        name.includes("pepper jack")
      );
    });
  }, [products]);
        ...
        <div className="max-w-container-max mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="font-serif text-3xl md:text-5xl text-on-surface">
              Pepperjack Collection
            </h2>

            <p className="mt-6 text-base md:text-lg leading-relaxed text-on-surface-variant">
              Explore our collection of Pepperjack wines, featuring distinctive
              Australian wines with bold flavour and character, carefully
              crafted for wine lovers and special occasions.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-container-max mx-auto">
          <div className="mb-8">
            ...
            <p className="mt-3 text-sm md:text-base text-on-surface-variant">
              Discover the most popular Pepperjack products.
            </p>
          </div>
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best selling Pepperjack products will appear here once product
      ...
      <section className="px-margin-mobile md:px-margin-desktop pb-20">
        <div className="max-w-container-max mx-auto">
          <div className="mb-8">
            ...
            <p className="mt-3 text-sm md:text-base text-on-surface-variant">
              Explore the highest-rated Pepperjack products.
            </p>
          </div>
          ...
          {productsLoading ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best rated Pepperjack products will appear here once product
          ...
          {brandProducts.length > 0 ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Pepperjack products will appear here once they are available
                  in our collection.
                </p>
              </div>
            </div>

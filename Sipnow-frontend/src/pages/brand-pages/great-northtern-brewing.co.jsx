...
import greatNorthernBanner from "../../assets/brandimages/GreatNorthernBrewingCo.jpg";

const BRAND_NAME = "Great Northern Brewing Co.";

export default function GreatNorthernBrewingCo({
  products = [],
  ...
  const brandProducts = useMemo(() => {
    return products.filter((product) => {
      ...
      return (
        ...
        name.includes("great northern brewing co") ||
        name.includes("great northern")
      );
    });
  }, [products]);
        ...
        <div className="max-w-container-max mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="font-serif text-3xl md:text-5xl text-on-surface">
              Great Northern Brewing Co. Collection
            </h2>

            <p className="mt-6 text-base md:text-lg leading-relaxed text-on-surface-variant">
              Discover Great Northern Brewing Co., a crisp and easy-drinking
              Australian beer range made for bright days, relaxed occasions and
              good company. Explore refreshing beers crafted for simple
              enjoyment.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="mt-3 text-sm md:text-base text-on-surface-variant">
                Discover the most popular Great Northern Brewing Co. products.
              </p>
            </div>
          </div>
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best selling Great Northern Brewing Co. products will appear
        ...
        <div className="max-w-container-max mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="mt-3 text-sm md:text-base text-on-surface-variant">
                Explore the highest-rated Great Northern Brewing Co. products.
              </p>
            </div>
          </div>
          ...
          {productsLoading ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best rated Great Northern Brewing Co. products will appear
      ...
      <section className="px-margin-mobile md:px-margin-desktop pb-24">
        <div className="max-w-container-max mx-auto">
          <div className="mb-8">
            ...
            <h2 className="font-serif text-3xl md:text-4xl text-on-surface">
              All Great Northern Brewing Co. Products
            </h2>
          </div>
          ...
          {brandProducts.length > 0 ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <h3 className="font-serif text-2xl text-on-surface mb-3">
                  Great Northern Brewing Co. Products
                </h3>

                <p className="text-on-surface-variant leading-relaxed">
                  Great Northern Brewing Co. products will appear here once they

...
import jacobsCreekBanner from "../../assets/brandimages/JacobsCreek.jpg";

const BRAND_NAME = "Jacob's Creek";

export default function JacobsCreek({
  products = [],
        ...
        <div className="max-w-container-max mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="font-serif text-3xl md:text-5xl text-on-surface">
              Jacob's Creek Collection
            </h2>

            <p className="mt-6 text-base md:text-lg leading-relaxed text-on-surface-variant">
              Explore our collection of Jacob's Creek wines. From refreshing
              whites to rich reds, discover bottles that bring together
              Australian character, quality and craftsmanship for every
              occasion.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="mt-3 text-sm md:text-base text-on-surface-variant">
                Discover the most popular Jacob's Creek products.
              </p>
            </div>
          </div>
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best selling Jacob's Creek products will appear here once
        ...
        <div className="max-w-container-max mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="mt-3 text-sm md:text-base text-on-surface-variant">
                Explore the highest-rated Jacob's Creek products.
              </p>
            </div>
          </div>
          ...
          {productsLoading ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best rated Jacob's Creek products will appear here once
          ...
          {brandProducts.length > 0 ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <h3 className="font-serif text-2xl text-on-surface mb-3">
                  Jacob's Creek Products
                </h3>

                <p className="text-on-surface-variant leading-relaxed">
                  Jacob's Creek products will appear here once they are

...
import hardRatedBanner from "../../assets/brandimages/hard-rated.png";

const BRAND_NAME = "Hard Rated";

export default function HardRated({
  products = [],

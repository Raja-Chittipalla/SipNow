...
import coopersBanner from "../../assets/brandimages/Coopers.jpg";

const BRAND_NAME = "Coopers";
...
export default function Coopers({
  ...
  const brandProducts = useMemo(() => {
    return products.filter((product) => {
      ...
      return (
        brand === "coopers" ||
        brand.includes("coopers") ||
        name.includes("coopers")
      );
    });
  }, [products]);
        ...
        <div className="max-w-container-max mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-6 text-base md:text-lg leading-relaxed text-on-surface-variant">
              Discover our collection of Coopers beers, proudly brewed in South
              Australia. From refreshing lagers to rich and full-bodied ales,
              explore the distinctive flavours and brewing tradition that have
              made Coopers a favourite Australian beer brand.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="mt-3 text-sm md:text-base text-on-surface-variant">
                Discover the most popular Coopers products.
              </p>
            </div>
          </div>
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best selling Coopers products will appear here once product
        ...
        <div className="max-w-container-max mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="mt-3 text-sm md:text-base text-on-surface-variant">
                Explore the highest-rated Coopers products.
              </p>
            </div>
          </div>
          ...
          {productsLoading ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Best rated Coopers products will appear here once product
          ...
          {brandProducts.length > 0 ? (
            ...
            <div className="glass-panel rounded-xl border border-primary/10 min-h-[240px] flex items-center justify-center px-6">
              <div className="text-center max-w-lg">
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Coopers products will appear here once they are available in
                  our collection.
                </p>
              </div>
            </div>
